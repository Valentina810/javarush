package src.main.java.com.github.valentina810.javasyntaxpro.robotpresentation;

/**
 * task11.task1103
 * В методе main создается 5 роботов и выводится информация о них.
 * Убери максимально возможное количество модификаторов static так, чтобы
 * функционал программы не изменился.
