package src.main.java.com.github.valentina810.javasyntaxpro.windowworks;

/**
 * task11.task1105
 * В классе Window есть метод changeSize, который должен менять размеры окна
 * на значения, переданные в метод.
